    ...
    <div className="lg:mt-28 mt-5 py-10" id="skillsSection">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <div className="w-full px-3 md:px-0  md:w-11/12  h-[700px] grid grid-cols-3 grid-rows-2 sm:grid-rows-3 gap-y-4 sm:gap-2 md:gap-3">
          ...
          <Link
            to={`https://yashmishra.hashnode.dev/${blogs[1]?.node.slug}`}
             target="_blank"
             rel="noopener noreferrer"
          ...
          <Link
            to={`https://yashmishra.hashnode.dev/${blogs[2]?.node.slug}`}
             target="_blank"
             rel="noopener noreferrer"
          ...
          <Link
            to={`https://yashmishra.hashnode.dev/${blogs[3]?.node.slug}`}
             target="_blank"
             rel="noopener noreferrer"
